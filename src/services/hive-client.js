...
const DID='did:hive:hiveforce-dataguardian';const ID={name:'HiveForce-DataGuardian',purpose:'Data protection — encryption orchestration, access control, PII masking, GDPR compliance',capabilities:["encryption_orchestration","access_control","pii_masking","gdpr_compliance"],did:DID};
...
async function registerWithHiveGate(){return p(`${G}/v1/gate/onboard`,{agent_name:'hive-data-guardian',purpose:ID.purpose})}
